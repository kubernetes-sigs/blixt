...
use crate::infrastructure::{ContainerImageError, KindClusterError};
...
pub enum Error {
    ...
    /// Error originating from an action related to `ContainerImages`
    #[error(transparent)]
    ContainerImage(#[from] ContainerImageError),
