...
func (r *TCPRouteReconciler) isTCPRouteManaged(ctx context.Context, tcproute gatewayv1alpha2.TCPRoute) (bool, *gatewayv1.Gateway, error) {
...
func (r *TCPRouteReconciler) verifyListener(_ context.Context, gw *gatewayv1.Gateway, tcprouteSpec gatewayv1alpha2.ParentReference) error {
	for _, listener := range gw.Spec.Listeners {
		if (listener.Protocol == gatewayv1.TCPProtocolType) && (listener.Port == gatewayv1.PortNumber(*tcprouteSpec.Port)) {
			return nil
		}
	}
...
func (r *TCPRouteReconciler) ensureTCPRouteConfiguredInDataPlane(ctx context.Context, tcproute *gatewayv1alpha2.TCPRoute, gateway *gatewayv1.Gateway) error {
...
func (r *TCPRouteReconciler) ensureTCPRouteDeletedInDataPlane(ctx context.Context, tcproute *gatewayv1alpha2.TCPRoute, gateway *gatewayv1.Gateway) error {
